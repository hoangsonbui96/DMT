	...
	<div class="row">
		...
		<div class="col-lg-12 col-md-12 col-sm-12">
			@component('admin.component.table')
				@slot('columnsTable')
					<tr>
						<th class="width3"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/id/" data-sort="{{ $sort_link }}">@lang('admin.stt')</a></th>
						<th class="width9"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/SDate/" data-sort="{{ $sort_link }}">@lang('admin.absence.start')</a></th>
						<th class="width9"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/EDate/" data-sort="{{ $sort_link }}">@lang('admin.absence.end')</a></th>
						...
						<th class="width9"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/Reason/" data-sort="{{ $sort_link }}">@lang('admin.absence.reason')</a></th>
						<th class="width5"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/Approve/" data-sort="{{ $sort_link }}">@lang('admin.absence.approve')</a></th>
						@if ($canEdit || $canDelete)
						<th class="width5">@lang('admin.action')</th>
						@endif
						<th class="width5"><a class="sort-link" data-link="{{ route("admin.AbsenceManagement") }}/Remark/" data-sort="{{ $sort_link }}">@lang('admin.absence.remark')</a></th>
					</tr>
				@endslot
				@slot('dataTable')
					@foreach($absences as $item)
						<tr class="even gradeC" data-id="">
							<td class = "width3 text-center">{{ $sort == 'desc' ? ++$stt : $stt-- }}</td>
