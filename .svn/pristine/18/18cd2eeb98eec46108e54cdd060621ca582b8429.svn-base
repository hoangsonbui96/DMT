        ...
        <div class="row">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                @component('admin.component.table')
                    @slot('columnsTable')
                        <tr>
                            <th class="width3"><a class="sort-link" data-link="{{ route("admin.AbsencesListApprove") }}/id/" data-sort="{{ $sort_link }}">@lang('admin.stt')</a></th>
                            ...
                            <th class="width9"><a class="sort-link" data-link="{{ route("admin.AbsencesListApprove") }}/SDate/" data-sort="{{ $sort_link }}">@lang('admin.absence.start')</a></th>
                            <th class="width9"><a class="sort-link" data-link="{{ route("admin.AbsencesListApprove") }}/EDate/" data-sort="{{ $sort_link }}">@lang('admin.absence.end')</a></th>
