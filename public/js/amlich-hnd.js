...
var FONT_SIZES = new Array("9pt", "10pt", "14pt");
...
function printStyle() {
	...
	res += '  .thang {font-size: '+fontSize+'; padding:1; line-height:100%; font-family:Tahoma,Verdana,Arial;table-}\n';
	res += '  .tenthang {text-align:center; font-size:125%; line-height:100%; font-weight:bold; color:#330033; background-color: #CCFFCC}\n';
	res += '  .navi-l {text-align:center; font-size:75%; line-height:100%; font-family:sans-serif,Times New Roman,Arial; font-weight:bold; color:red; background-color: #CCFFCC}\n';
	...
	res += '  .ngaytuan {text-align:center;line-height:100%; color:#330033; background-color: #FFFFCC}\n';
	res += '  .ngaythang {background-color:#FDFDF0}\n';
	res += '  .homnay {background-color:#FFF000}\n';
	res += '  .tet {background-color:#FFCC99}\n';
	res += '  .am {text-align:right;font-size:75%;line-height:100%;color:blue}\n';
	res += '  .am2 {text-align:right;font-size:75%;line-height:100%;color:#004080}\n';
	res += '  .t2t6 {text-align:left;font-size:130%;color:black}\n';
...
function printTable(mm, yy) {
	...
	var res = "";
	res += ('<table class="table table-bordered thang">\n');
	res += printHead(mm, yy);
	for (i = 0; i < 6; i++) {
		res += ("<tr>\n");
		for (j = 0; j < 7; j++) {
...
function printHead(mm, yy) {
	var res = "";
	var monthName = mm;
	res += ('<tr><th colspan="7" class="tenthang">'+monthName+'</th>\n');
	res += ('</tr>\n');
	for(var i=0;i<=6;i++) {
...
function printEmptyCell() {
		return '<td class="ngaythang empty"><div class=cn>&nbsp;</div> <div class=am>&nbsp;</div></td>\n';
}

function printCell(lunarDate, solarDate, solarMonth, solarYear) {
	var cellClass, solarClass, lunarClass, solarColor,dd,mm;
	cellClass = "ngaythang notempty";
	solarClass = "sdate t2t6";
	lunarClass = "am";
	solarColor = "black";
	...
	if (dow == 0) {
		cellClass = "ngaythang notempty sun";
		solarClass = "sdate cn";
		solarColor = "red";
	} else if (dow == 6) {
		cellClass = "ngaythang notempty sat";
		solarClass = "sdate t7";
		solarColor = "red";
	}
	if (solarDate == today.getDate() && solarMonth == today.getMonth()+1 && solarYear == today.getFullYear()) {
		cellClass = "ngaythang notempty homnay";
	}
	if (lunarDate.day == 1 && lunarDate.month == 1) {
		cellClass = "ngaythang notempty tet";
	}
	if (lunarDate.leap == 1) {
		lunarClass = "am2";
	}
	...
	res += ('<td class="'+cellClass+'" data-day="'+dd+'" data-month="'+mm+'" data-year="'+solarYear+'"');
	// if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'" onClick="alertDayInfo('+args+');">');
	if (lunarDate != null) res += (' title="'+getDayName(lunarDate)+'">');
